...
int musica_natal[] = { //15 Notas
  ...
  NOTE_A5,4, NOTE_A5,8, NOTE_AS5,8
  //, NOTE_A5,8, NOTE_G5,8,
  //NOTE_F5,4, NOTE_D5,4, NOTE_C5,8,
  // NOTE_C5,8, NOTE_D5,4, NOTE_G5,4, NOTE_E5,4
...
int musica_asa_branca[] = { //15 Notas
  ...
  NOTE_B4,4
  //, NOTE_D5,4, REST,8, NOTE_D5,8, NOTE_C5,8, NOTE_B4,8,
...
int musica_compadecida[] = { //15 Notas
  ...
  NOTE_C5,4, NOTE_G4,8, NOTE_AS4,4, NOTE_A4,8,
  NOTE_G4,16
  //, NOTE_C4,8, NOTE_C4,16, NOTE_G4,16, NOTE_G4,8, NOTE_G4,16,
...
int musica_rickroll[] = { //15 Notas
  ...
  REST,8, NOTE_B4,8, NOTE_D5,8, NOTE_B4,8
  //, NOTE_D5,8, NOTE_E5,4, REST,8,
  //REST,8, NOTE_CS5,8
  //, NOTE_B4,8, NOTE_A4,-4, REST,4,
...
int musica_pantera[] = { //15 Notas
  ...
  NOTE_AS4,2, NOTE_A4,-16
  //, NOTE_G4,-16, NOTE_E4,-16, NOTE_D4,-16, 
  //NOTE_E4,2, REST,4
  //, REST,8, NOTE_DS4,4,
  // NOTE_E4,-4, REST,8, NOTE_FS4,8, NOTE_G4,-4, REST,8, NOTE_DS4,8,
...
int musica_aha[] = { //15 Notas
  ...
  //, NOTE_D5,8, REST,8, NOTE_FS5,8, 
  //REST,8, NOTE_FS5,8
  // ,REST,8, NOTE_FS5,8, NOTE_E5,8, NOTE_E5,8, NOTE_FS5,8, NOTE_E5,8,
  // NOTE_FS5,8, NOTE_FS5,8,NOTE_D5,8, NOTE_B4,8, REST,8, NOTE_B4,8, REST,8, NOTE_E5,8,
};  
int musica_keyboard_cat[] = { //15 Notas  
    ...
    //NOTE_G3,4, NOTE_B3,8, NOTE_D4,-4, NOTE_B3,4, NOTE_G3,4
